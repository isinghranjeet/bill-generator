...
//   // Invoice number is a plain, directly-bound text input. Typing writes
//   // straight to details.invoiceNo, which is what Print Preview and PDF
//   // export read, so there is no possibility of it going out of sync.
...
export const ProfessionalInvoice = React.memo(({
  ...
  // ---- Invoice number: fixed "202605" prefix, editable suffix only ----
